...
public class Exploder : MonoBehaviour {
    ...
    static bool testExplosion = false;
    static bool testPosition;
	...
	void FixedUpdate() {
        ...
        if (testExplosion == true && !exploded && testPosition)
        {
            testExplosion = false;
            testPosition = false;
            StartCoroutine("explode");
    ...
    public void VerifPosition(bool test)
    {
        testPosition = test;
    }

    public void explosionDeOuf()
    {
        testExplosion = true;
    }
